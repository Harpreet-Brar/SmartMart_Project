...
public class Source {
    ...
    public static class Builder {
        ...
        public Builder setRequestedFps(float fps) {
            ...
            mSource.mRequestedFps = fps;
            return this;
        }

        public Builder setFocusMode(@FocusMode String mode) {
            mSource.mFocusMode = mode;
            return this;
        }

        public Builder setFlashMode(@FlashMode String mode) {
            mSource.mFlashMode = mode;
            return this;
        }
        ...
        public Builder setRequestedPreviewSize(int width, int height) {
            ...
            mSource.mRequestedPreviewWidth = width;
            mSource.mRequestedPreviewHeight = height;
            return this;
        }
         ...
         */
        public Source build() {
            mSource.mFrameProcessor = mSource.new FrameProcessingRunnable(mDetector);
            return mSource;
        }
    }
    ...
    public Source start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public Source start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
