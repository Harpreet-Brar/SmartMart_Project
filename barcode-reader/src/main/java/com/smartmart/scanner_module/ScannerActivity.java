 ...
 * goes away.
 */
class ScannerActivity extends Tracker<Barcode> {
    private Overlay<ColorSetting> mOverlay;
    private ColorSetting mGraphic;
    private BarcodeGraphicTrackerListener listener;

    ScannerActivity(Overlay<ColorSetting> overlay, ColorSetting graphic, BarcodeGraphicTrackerListener listener) {
        mOverlay = overlay;
        mGraphic = graphic;
